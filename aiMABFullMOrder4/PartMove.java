...
public class PartMove {
	...
	public PartMove(int[][] state, TreeSet<Move> bestMove) {
		if (!bestMove.isEmpty()) {
		...
		for (int i = 0; i < 11 ; i++) {
			for (int j = ((i%2)==0?1:0) ; j < 11 ; j+=2) {
				//add the fourth side
				if ( i == 0 && state[i+1][j] == 4 && state[i][j] == 0 ) {
					
					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if (i == 10 && state[i-1][j] == 4 && state[i][j] == 0) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if ((i%2) == 0 && i >= 2 && i <= 8 && (state[i-1][j] == 4 || state[i+1][j] == 4) && state[i][j] == 0) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if ( j == 0 && state[i][j+1] == 4 && state[i][j] == 0 ) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if (j == 10 && state[i][j-1] == 4 && state[i][j] == 0) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if ((j%2) == 0 && j >= 2 && j <= 8  && (state[i][j-1] == 4 || state[i][j+1] == 4) && state[i][j] == 0) {
		...
		for (int i = 0; i < 11 ; i++) {
			for (int j = ((i%2)==0?1:0); j < 11 ; j+=2) {
				//add the second and 
				if ( i == 0 && state[i+1][j] <= 2 && state[i][j] == 0 ) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if (i == 10 && state[i-1][j] <= 2 && state[i][j] == 0) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if ((i%2) == 0 && i >= 2 && i <= 8 && state[i-1][j] <= 2 && state[i+1][j] <= 2 && state[i][j] == 0) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if ( j == 0 && state[i][j+1] <= 2 && state[i][j] == 0 ) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if (j == 10 && state[i][j-1] <= 2 && state[i][j] == 0) {

					move.add(new Move(i, j));
					state[i][j] = -2;
				}else if ((j%2) == 0 && j >= 2 && j <= 8 && state[i][j-1] <= 2 && state[i][j+1] <= 2 && state[i][j] == 0) {
