...
//	private static final int stage1 = 1;
	...
	private Move randomMove() {
		MctsNode node = new MctsNode(ai, man, matrix );
		CopyOfMcts mcts = new CopyOfMcts(node);
...
/*	private Move miniMaxMove() {
	...
	private Move sMove() {
		...
		minimax.score(node, true, 15 + 4*countM);
	...
	public int judgeStage() {
		...
		if (GETwo < 18) {//the chain almost come into being at 21, 22, so should set it 18,19
			return stage0;
		}
		else if (GETwo >= 18) {
			return stage2;
