...
public class GameStateM22 {
	...
	private Move randomMove() {
		MinimaxABT3D7 minimax = new MinimaxABT3D7();
		Node node = new Node(ai, man, matrix);
		minimax.score(node, true, 7);//must perform it first
		return MinimaxABT3D7.bestMove;
	...
	private Move miniMaxMove() {
		MinimaxABT3D8 minimax = new MinimaxABT3D8();
		Node node = new Node(ai, man, matrix);
		minimax.score(node, true, 8);//must perform it first
		return MinimaxABT3D8.bestMove;
	}
