...
/*	
	...
	private Move miniMaxMove() {
		MinimaxABO minimax = new MinimaxABO();
		Node node = new Node(ai, man, matrix);
		minimax.score(node, true, 12);//must perform it first
		return MinimaxABO.bestMove;
	}
	private Move miniMaxMove2() {
		MinimaxABO minimax = new MinimaxABO();
		Node node = new Node(ai, man, matrix);
		minimax.score(node, true, 14);//must perform it first
		return MinimaxABO.bestMove;
	}
